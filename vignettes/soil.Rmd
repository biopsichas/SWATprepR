...
p4 <- ggplot(soils) + 
  ...
  theme_void()
##Combining into one
cowplot::plot_grid(p1, p2, p3, p4, ncol = 2,  labels = c('Impervious depth', 'Water level', 'Drainage status', 'Soil types'), label_x = 0, label_y = 0, hjust = -0.1, vjust = -0.5, label_size = 10)
...
p5 <- ggplot(soils) + 
  ...
  theme_void()
cowplot::plot_grid(p4, p5, ncol = 2,  labels = c('Original soil map', 'New soil map'), label_x = 0, label_y = 0, hjust = -0.1, vjust = -0.5, label_size = 10)
```
