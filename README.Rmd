...
You can install the development version of SWATprepR from [GitHub](https://github.com/biopsichas/SWATprepR). Please be aware that the `euptf2` [package](https://github.com/tkdweber/euptf2) has to be installed first. 
