...
`r badge_license("MIT")`
`r badge_doi("https://doi.org/10.5281/zenodo.10167075", "yellow")`
...
- [SWATrunR (former SWATplusR)](https://chrisschuerz.github.io/SWATplusR/articles/SWATplusR.html) - R tool for running SWAT models for different parameters and scenarios.
...
You can install the development version of SWATprepR from [GitHub](https://github.com/biopsichas/SWATprepR). Please be aware that running [`get_usersoil_table()`](reference/get_usersoil_table.html) function the `euptf2` [package](https://github.com/tkdweber/euptf2) has to be installed. 
